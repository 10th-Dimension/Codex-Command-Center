...
export const sectionContent: Record<string, SectionContent> = {
  repositories: {
    ...
    note: "Repository metadata will appear here when a GitHub provider is connected.",
  ...
  activity: {
    ...
    note: "The activity stream is waiting for one or more trusted providers.",
  ...
  "pull-requests-issues": {
    ...
    note: "Pull request and issue records will be shown without local placeholders once connected.",
  ...
  "build-ci-health": {
    ...
    note: "Build and workflow evidence is unavailable until a CI provider is connected.",
  ...
  "data-sources": {
    ...
    note: "The initial registry is intentionally empty of live integrations.",
